...
{
    /// <summary>
    /// EasySurvivalCreateOxygenGenerator
    /// </summary>
    internal class EasySurvivalCreateOxygenGenerator : EasySurvivalCreateBase
    {
        /// <summary>
        /// データ作成
        /// </summary>
        public override void Create(string srcPath, string dstPath)
        {
            ...
            foreach (decimal factor in factorList)
            {
                ...
                string dstPath1 = @"";
#else
                string dstPath1 = @$"Easy_Survival OxygenGenerator x {factor.ToString("0")}\Data";
#endif
